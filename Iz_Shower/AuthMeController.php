...
abstract class AuthMeController {
    ...
    private function getAuthmeMySqli() {
        $mysqli = new mysqli($dbhost, // Phần Host - Config ở db-config.php
        "tcceldoradoga_myproject", // Phần user
        "tcceldoradoga_myproject", // Phần password
        "tcceldoradoga_myproject"); // Phần Tên Database
        if (mysqli_connect_error()) {
            printf('<p style="color: white;">Bạn còn thiếu config database ở Iz_Shower/AuthMeController.php.</p> Errno: %d, error: "%s"',
