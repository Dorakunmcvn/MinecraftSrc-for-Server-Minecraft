...
<center>
    ...
    <div class="border-content">
        <h1 id="title">GIFTCODE</h1>
        <p id="description"><?php echo $gift_line; ?></p>
    </div>
    <br />
    <div class="border-content">
        <h1 id="title">Làm sao để tôi có giftcode cho riêng tôi ?</h1>
        <p id="description"><?php echo $gift_line_2; ?></p>
